# YingCe Studio Desktop Releases

This public repository is used only for YingCe Studio Windows desktop auto-update releases.

Release assets may include:

- `latest.yml`
- `YingCeStudio-Setup-<version>-x64.exe`
- `YingCeStudio-Setup-<version>-x64.exe.blockmap`
